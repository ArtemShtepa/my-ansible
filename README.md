# Решения задач лекции 8.4 Работа с Roles
...
1. Установка **Vector**: `Install Vector` используя роль [ArtemShtepa/vector-role](https://github.com/ArtemShtepa/vector-role)
1. Установка **Lighthouse** включая **nginx**: `Install Lighthouse` используя роль [ArtemShtepa/lighthouse-role](https://github.com/ArtemShtepa/lighthouse-role)
...
Используется роль [AlexeySetevoi/ansible-clickhouse](https://github.com/AlexeySetevoi/ansible-clickhouse) со следующими параметрами:
...
Используется роль [ArtemShtepa/vector-role](https://github.com/ArtemShtepa/vector-role) со следующими параметрами:
...
Используется роль [ArtemShtepa/lighthouse-role](https://github.com/ArtemShtepa/lighthouse-role) со следующими параметрами:
